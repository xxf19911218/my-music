...
function SiriWave(opt) {
  ...
  if (!this.colors) {
    var singleColor = hex2rgb(opt.color || '#fff') || '255,255,255';
    this.colors = [
      'rgba(' + singleColor + ',0.1)',
      'rgba(' + singleColor + ',0.2)',
      'rgba(' + singleColor + ',0.4)',
      'rgba(' + singleColor + ',0.6)',
      'rgb(' + singleColor + ')'
    ];
  }
...
SiriWave.prototype._draw = function() {
  ...
  this._clear();
  this._drawLine(-2, this.colors[0]);
  this._drawLine(-6, this.colors[1]);
  this._drawLine(4, this.colors[2]);
  this._drawLine(2, this.colors[3]);
  this._drawLine(1, this.colors[4] || this.colors[0], 1.5);
